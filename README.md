...
Vue.js is an MIT-licensed open source and independent project. Thanks to the support by these awesome [backers](https://github.com/vuejs/vue/blob/dev/BACKERS.md), the development is ongoing. If you'd like to join them, please consider:
