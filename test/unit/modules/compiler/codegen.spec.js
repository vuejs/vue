...
describe('codegen', () => {
  ...
  it('generate events with keycode', () => {
    assertCodegen(
      ...
      `with(this){return _c('input',{on:{"input":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"enter",13,$event.key,"Enter")))?null:onInput.apply(null, arguments)}}})}`
    )
    // multiple keycodes (delete)
    assertCodegen(
      '<input @input.delete="onInput">',
      `with(this){return _c('input',{on:{"input":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"delete",[8,46],$event.key,["Backspace","Delete","Del"])))?null:onInput.apply(null, arguments)}}})}`
    )
    // multiple keycodes (esc)
    assertCodegen(
      '<input @input.esc="onInput">',
      `with(this){return _c('input',{on:{"input":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"esc",27,$event.key,["Esc","Escape"])))?null:onInput.apply(null, arguments)}}})}`
    )
    // multiple keycodes (space)
    assertCodegen(
      '<input @input.space="onInput">',
      `with(this){return _c('input',{on:{"input":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"space",32,$event.key,[" ","Spacebar"])))?null:onInput.apply(null, arguments)}}})}`
    )
    // multiple keycodes (chained)
    assertCodegen(
      '<input @keydown.enter.delete="onInput">',
      `with(this){return _c('input',{on:{"keydown":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"enter",13,$event.key,"Enter")&&_k($event.keyCode,"delete",[8,46],$event.key,["Backspace","Delete","Del"])))?null:onInput.apply(null, arguments)}}})}`
    )
    // number keycode
    assertCodegen(
      '<input @input.13="onInput">',
      `with(this){return _c('input',{on:{"input":function($event){return ((!$event.type.indexOf('key')&&$event.keyCode!==13))?null:onInput.apply(null, arguments)}}})}`
    )
    // custom keycode
    assertCodegen(
      '<input @input.custom="onInput">',
      `with(this){return _c('input',{on:{"input":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"custom",undefined,$event.key,undefined)))?null:onInput.apply(null, arguments)}}})}`
    )
  })
  ...
  it('generate events with generic modifiers', () => {
    ...
    assertCodegen(
      ...
      `with(this){return _c('input',{on:{"input":function($event){return ($event.target !== $event.currentTarget)?null:onInput.apply(null, arguments)}}})}`
    )
  })
  ...
  it('generate events with generic modifiers and keycode correct order', () => {
    assertCodegen(
      ...
      `with(this){return _c('input',{on:{"keydown":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"enter",13,$event.key,"Enter"))||$event.preventDefault())?null:onInput.apply(null, arguments)}}})}`
    )

    assertCodegen(
      '<input @keydown.enter.stop="onInput">',
      `with(this){return _c('input',{on:{"keydown":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"enter",13,$event.key,"Enter"))||$event.stopPropagation())?null:onInput.apply(null, arguments)}}})}`
    )
  })
  ...
  it('generate events with mouse event modifiers', () => {
    assertCodegen(
      ...
      `with(this){return _c('input',{on:{"click":function($event){return (!$event.ctrlKey)?null:onClick.apply(null, arguments)}}})}`
    )
    assertCodegen(
      '<input @click.shift="onClick">',
      `with(this){return _c('input',{on:{"click":function($event){return (!$event.shiftKey)?null:onClick.apply(null, arguments)}}})}`
    )
    assertCodegen(
      '<input @click.alt="onClick">',
      `with(this){return _c('input',{on:{"click":function($event){return (!$event.altKey)?null:onClick.apply(null, arguments)}}})}`
    )
    assertCodegen(
      '<input @click.meta="onClick">',
      `with(this){return _c('input',{on:{"click":function($event){return (!$event.metaKey)?null:onClick.apply(null, arguments)}}})}`
    )
    assertCodegen(
      '<input @click.exact="onClick">',
      `with(this){return _c('input',{on:{"click":function($event){return ($event.ctrlKey||$event.shiftKey||$event.altKey||$event.metaKey)?null:onClick.apply(null, arguments)}}})}`
    )
    assertCodegen(
  ...
  it('generate events with multiple modifiers', () => {
    assertCodegen(
      ...
      `with(this){return _c('input',{on:{"input":function($event){return ($event.stopPropagation()||$event.preventDefault()||$event.target !== $event.currentTarget)?null:onInput.apply(null, arguments)}}})}`
    )
  })
  ...
  it('generate events with capture modifier', () => {
    assertCodegen(
      ...
      `with(this){return _c('input',{on:{"!input":function($event){onInput.apply(null, arguments)}}})}`
    )
  })
  ...
  it('generate events with inline function expression', () => {
    ...
    assertCodegen(
      ...
      `with(this){return _c('input',{on:{"keyup":function($event){return ((!$event.type.indexOf('key')&&_k($event.keyCode,"enter",13,$event.key,"Enter")))?null:(e=>current++).apply(null, arguments)}}})}`
    )
  })
