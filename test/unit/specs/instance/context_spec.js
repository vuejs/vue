...
describe('Instance Context', function () {
  ...
  describe('option context', function() {
    ...
    it('object', function () {
      ...
      expect(vm.$.a.f2).toEqual(vm.$.a.f4)
      expect(spy).toHaveBeenCalledWith(vm.f1, 'f1')
      expect(vm.$.a.f3).toEqual(vm.f3)
    })
    ...
    it('incompleted childContext', function () {
      ...
      expect(vm.$.a.f1).toBeDefined()
      expect(vm.$.a.f3).toBeUndefined()
    ...
    it('not merge parent vm\'s context', function () {
      ...
      expect(vm.$.a.$.b.f3).toEqual(vm.$.a.f3)
      expect(vm.$.a.$.b.f1).toBeUndefined()
    })

    it('can pass methods declared in context to childContext', function () {
      var vm = new Vue({
        template: '<v-a v-ref="a"></v-a>',
        childContext: ['f1', 'f2'],
        methods: {
      ...
      expect(vm.$.a.f1).toEqual(vm.f1)
      expect(vm.$.a.$.b.f1).toEqual(vm.$.a.f1)
    })
  })
